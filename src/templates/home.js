  ...
  return(
    ...
    for the entertainment industry in Los Angeles and beyond.</p>
      ...
      <div className="promise">
          <div className="container">
            <LazyLoad once offset={100}><img src={codyFoldedArms} className="cody-arms" alt="Cody Vlach as a Paramedic" /></LazyLoad>
            <div className="copy">
      ...
      <div className="image-carousel">
        <Slider {...settings2}>
            {pageData.acf.carousel.map((photo) => (
                <div>
                    <LazyLoad height={348} once offset={100}><img src={photo.image.source_url} alt={photo.image.alt_text} /></LazyLoad>
                </div>
            ))}        
        </Slider>
      </div>
